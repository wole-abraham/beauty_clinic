        ...
        <div className="container">
          <div className="about-page-grid">
            <div>
              ...
              <p style={{ color: "#555", lineHeight: 1.75, marginBottom: 8 }}>
              ...
              <div className="about-info-list">
                ...
                <div className="about-info-row">
                  ...
                  <a href="https://wa.me/9613799407">+961 3 799 407</a>
                </div>
                <div className="about-info-row">
                  <i className="fas fa-envelope about-info-icon" />
                  <a href="mailto:customerservice@marynassifchbat.com">customerservice@marynassifchbat.com</a>
                </div>
              </div>
              <div className="about-socials">
                <a href="https://web.facebook.com/marynassifchbat" className="btn btn-dark btn-sm"><i className="fab fa-facebook-f" /> Facebook</a>
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {[
              ...
              <div key={title} className="contact-card" style={{ background: "white" }}>
                <div className="contact-icon"><i className={"fas " + icon} /></div>
                <h4 style={{ marginBottom: 8, fontSize: "1rem" }}>{title}</h4>
                <p style={{ color: "var(--muted)", fontSize: "0.87rem", lineHeight: 1.65 }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
